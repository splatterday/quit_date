...
var CalPosOffsetX = -100; //X position offset relative to calendar icon, can be negative value
var CalPosOffsetY = -10; //Y position offset relative to calendar icon, can be negative value
...
function selectDate(element, date) {
    Cal.Date = date;
    selDate = new Date(Cal.Year, Cal.Month, Cal.Date, Cal.Hours, Cal.Minutes, Cal.Seconds);
